    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container max-w-5xl mx-auto px-6 py-10">
        ...
        <p className="text-muted-foreground mb-8">
          {isMember ? "You're a Founding Member — thank you!" : "Upgrade to unlock saving, private stories, and book creation."}
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Card className="opacity-60">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Save and organise your stories. {!isMember && "(Members only)"}</p>
            </CardContent>
          </Card>
          <Card className="opacity-60">
            <CardHeader>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Turn stories into a printable book. {!isMember && "(Members only)"}</p>
            </CardContent>
          </Card>
          <Card className="opacity-60">
            <CardHeader>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Group stories by child or theme. {!isMember && "(Members only)"}</p>
            </CardContent>
          </Card>
        </div>
      </main>
